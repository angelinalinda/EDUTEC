/* ============================================================
   CONEXÕES GEOPOLÍTICAS — TELA INICIAL (jogo.html)
   Esta página é apenas o "começo do jogo": mostra o título,
   as instruções e o botão para começar. A partida em si
   (tabuleiro jogável + resultado) acontece em partida.html.
   ============================================================ */
(function () {
  'use strict';
  ...
  /* ---------- Bolinhas de erro (apenas visual nesta tela) ---------- */
  function initMistakeDots(total) {
    var container = document.getElementById('mistakeDots');
    if (!container) return;
    container.innerHTML = '';
  ...
  /* ---------- Botão "Novo jogo" leva para a partida real ---------- */
